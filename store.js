...
export function load(){try{const s=localStorage.getItem('sternklar-v1');return s?validate(JSON.parse(s)):defaults();}catch{return defaults();}}
export function save(state){localStorage.setItem('sternklar-v1',JSON.stringify(state));}
