...
test('Service worker waits for consent and removes only outdated Sternklar shell caches',async()=>{
 ...
 vm.runInNewContext(fs.readFileSync(new URL('../sw.js',import.meta.url),'utf8'),{self,caches:{keys:async()=>['sternklar-shell-v1.0.0','sternklar-shell-v1.3.0','sternklar-images-v1','other-app'],delete:async k=>deleted.push(k)}});
